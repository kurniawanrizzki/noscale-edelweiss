...
public class PackageRemoteDataSource implements PackageDataSource {
    ...
    public void getList(GetLoadCallback callback) {
        ...
        response.enqueue(new Callback<PackageListResponse>() {
            ...
            public void onResponse(Call<PackageListResponse> call, Response<PackageListResponse> response) {
                ...
                List<WeddingPackage> data = new ArrayList<>();

                if ((null != res) && res.isOk()) {
                    data = res.getPackages();
                }
    ...
    @Override
    public void edit(PackageEditRequest request, PostCallback callback) {
        Call<BaseResponse> response = mService.getPackageApi().edit(request);
        response.enqueue(new Callback<BaseResponse>() {
            @Override
            public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                try {
    ...
    @Override
    public void delete(int id, PostCallback callback) {
        Call<BaseResponse> response = mService.getPackageApi().delete(id);
        response.enqueue(new Callback<BaseResponse>() {
            @Override
            public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                try {
